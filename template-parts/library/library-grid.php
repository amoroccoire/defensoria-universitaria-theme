...
<div class="flex-grow">
    ...
    <div class="flex justify-center items-center space-x-2">
        ...
        <?php for ($i = 1; $i <= $total_pages; $i++) : ?>
            ...
            <a href="<?php echo esc_url(get_pagenum_link($i));?>" class="inline-flex items-center justify-center w-10 h-10 rounded-xs border border-gray-300 bg-white text-gray-700 hover:text-blue-600 transition-colors shadow-sm font-medium">
                <?php echo intval($i); ?>
            </a>
        ...
        <a href="<?php echo esc_url(get_pagenum_link($paged + 1));?>"
            class="inline-flex items-center justify-center w-5 h-5 rounded-xs text-gray-500 hover:bg-white hover:text-gray-700 transition-colors">
